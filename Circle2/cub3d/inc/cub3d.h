...
typedef	struct	s_map_info
{
	...
	int			screen_width;
	int			screen_height;
	char		*n_wall_texture_path;
	char		*s_wall_texture_path;
	char		*w_wall_texture_path;
	char		*e_wall_texture_path;
...
int				parse_no_texture_path(char *detailed_info,
									t_map_info *map_info);
int				parse_so_texture_path(char *detailed_info,
									t_map_info *map_info);
int				parse_we_texture_path(char *detailed_info,
									t_map_info *map_info);
int				parse_ea_texture_path(char *detailed_info,
									t_map_info *map_info);
int				parse_s_texture_path(char *detailed_info,
									t_map_info *map_info);
...
void			get_map_line(t_map_info *map_info,
...
void			copy_world_map(t_map_info *map_info,
								char **test_map);
...
** initial_setting.c
*/
void			setup_player_info(t_player_info *p_info,
								t_map_info *map_info);
...
void			setup_direction_vectors(t_player_info *p_info,
											int i);
void			setup_player_direction(t_player_info *p_info,
										t_map_info *map_info);
void			setup_screen_map_config(t_player_info *p_info,
										t_map_info *map_info);
...
void			calc_perp_wall_dist(t_player_info *p_info,
									t_wall_casting_info *w_info);
